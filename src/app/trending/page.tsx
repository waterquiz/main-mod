  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-12">
        ...
        <p className="text-foreground/70 mt-2">Discover the most popular and downloaded mods this week.</p>
      </div>

      {/* Top AdSense Placement */}
      {displayedApps.length > 0 && (
        <AdBanner728 placement="trending" index={1} />
      )}
        ...
        <div className="space-y-12">
          {chunkedApps.map((chunk, chunkIndex) => (
            <div key={chunkIndex} className="space-y-12">
              ...
              <AdBanner728 placement="trending" index={chunkIndex + 1} />
            </div>
          ))}
        </div>
      ) : (
